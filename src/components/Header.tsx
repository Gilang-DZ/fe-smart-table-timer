  ...
  return (
    <header className="sticky top-0 z-50 bg-[#171717] border-b border-[#262626] px-8 py-3.5 flex items-center justify-between">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-sm font-black tracking-tight uppercase text-white">Smart Table Timer</h1>
          <p className="text-[10px] text-[#737373] font-black uppercase tracking-widest">Billiard 805 • Parung</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-10">
        <div className="flex gap-8">
          <div className="text-right">
            <p className="text-[10px] text-[#737373] font-black uppercase tracking-[0.15em] mb-0.5">Current Date</p>
            <p className="text-xs font-bold uppercase text-[#e5e5e5]">
              {currentTime.toLocaleDateString([], { weekday: 'short', day: '2-digit', month: 'short' })}
            </p>
          </div>
          <div className="text-right border-l border-[#262626] pl-8">
            <p className="text-[10px] text-[#737373] font-black uppercase tracking-[0.15em] mb-0.5">Terminal Time</p>
