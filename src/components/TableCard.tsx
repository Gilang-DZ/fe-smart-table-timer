...
// // --- KONFIGURASI HARGA (Bisa dipindah ke file config) ---
// const PRICE_PER_HOUR = 50000; // Contoh: Rp 50.000 per jam
...
//       startTime: start,
//       endTime: end,
//       // @ts-ignore (tambahin di type Table lo nanti)
...
//   const getBorderColor = () => {
//     switch (table.status) {
//       case TableStatus.AVAILABLE: return "border-green-500/30";
//       case TableStatus.ENDING_SOON: return "border-amber-500 animate-pulse";
//       case TableStatus.IN_USE: return "border-red-500/50";
...
//          <div 
//             className={`h-full transition-all duration-1000 ${table.status === TableStatus.ENDING_SOON ? 'bg-amber-500' : 'bg-red-600'}`}
...
//             {table.name}
//           </h3>
//           {/* Nampilin Nama Customer kalau ada */}
...
//       {/* Input Nama (Muncul cuma pas Available & mau start) */}
//       {table.status === TableStatus.AVAILABLE && (
//         <input 
//           type="text"
//           placeholder="Customer Name..."
//           className="w-full bg-neutral-900 border border-neutral-800 rounded-lg px-3 py-2 text-xs text-white mb-4 focus:outline-none focus:border-green-500"
...
//       {/* Detail Waktu & Billing */}
//       {table.status !== TableStatus.AVAILABLE && (
//         <div className="w-full mt-6 space-y-4">
//           <div className="grid grid-cols-2 gap-2 border-y border-white/5 py-4">
//             <div className="text-center">
//               <p className="text-[10px] text-neutral-500 uppercase font-bold">In</p>
//               <p className="text-sm text-neutral-200 font-mono">{formatTime(table.startTime)}</p>
//             </div>
//             <div className="text-center border-l border-white/5">
//               <p className="text-[10px] text-neutral-500 uppercase font-bold">Out</p>
//               <p className="text-sm text-neutral-200 font-mono">{formatTime(table.endTime)}</p>
//             </div>
//           </div>

//           <div className="bg-neutral-900/50 rounded-xl p-3 flex justify-between items-center border border-white/5">
//             <span className="text-[10px] text-neutral-400 font-bold uppercase">Billing Est.</span>
